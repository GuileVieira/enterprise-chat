...
export const metadata: Metadata = {
  ...
  description: "Obrigado por se interessar no Orqest. Agende sua reuniao de diagnostico gratuito.",
};
    ...
    <main className="flex min-h-[100dvh] items-center justify-center bg-background px-6">
      <div className="mx-auto max-w-xl text-center">
        ...
        <p className="mt-6 text-lg leading-relaxed text-text-secondary">
          Baseado nas suas respostas, voce e um bom fit para o Orqest. Agende agora sua reuniao de 30 minutos para mapearmos sua operacao.
        </p>

        <div className="mt-10">
          <MagneticButton href="https://cal.com/orqest/diagnostico">
            Agendar minha reuniao de 30 minutos
          </MagneticButton>
        </div>

        <p className="mt-6 text-sm text-text-muted">
          Ou, se preferir, baixe nosso guia de processos operacionais para agencias.
        </p>
