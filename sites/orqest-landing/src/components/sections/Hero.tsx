...
export function Hero({ onCtaClick }: HeroProps) {
  ...
  return (
    <section className="relative flex min-h-[100dvh] items-center overflow-hidden bg-background">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_72%_18%,rgba(184,171,216,0.28),transparent_34%),linear-gradient(180deg,rgba(27,26,23,0.035),transparent_42%)]" />
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-4 py-28 sm:px-6 md:grid-cols-[minmax(0,1.08fr)_minmax(360px,0.92fr)] md:gap-10 lg:py-36">
        <div className="flex flex-col justify-center">
          ...
          <motion.div
            ...
            className="mt-10 grid max-w-xl grid-cols-2 gap-px overflow-hidden rounded-2xl border border-black/10 bg-black/10 sm:grid-cols-4"
          >
            {operations.map((item) => (
        ...
        >
          <div className="relative w-full max-w-[520px]">
            <div className="border-moss/20 bg-moss/10 absolute -left-7 top-12 h-44 w-36 rounded-[2rem] border" />
            <div className="bg-surface-raised relative overflow-hidden rounded-[2.25rem] border border-black/[0.12] p-6 shadow-[0_32px_70px_-42px_rgba(67,61,52,0.48)]">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_24%_18%,rgba(184,171,216,0.36),transparent_34%)]" />
              <div className="relative">
                <div className="flex items-center justify-between border-b border-black/10 pb-5">
                  <div>
                    <p className="text-moss font-mono text-xs uppercase tracking-[0.18em]">
                      Operação instalada
                    </p>
                  ...
                  <motion.div
                    ...
                    className="bg-moss h-2.5 w-2.5 rounded-full"
                  />
                </div>
                ...
                <div className="mt-6 grid grid-cols-[0.82fr_1.18fr] gap-4">
                  <div className="space-y-3">
                    {['Briefing', 'Roteiro', 'Pauta'].map((item, index) => (
                      <motion.div
                        ...
                        className="bg-surface rounded-2xl border border-black/[0.1] p-4"
                      >
                        <p className="text-moss font-mono text-[11px] uppercase tracking-[0.18em]">
                          agente
                        </p>
                  ...
                  <div className="rounded-[1.6rem] border border-black/[0.1] bg-background/70 p-5">
                    ...
                    <div className="mt-5 space-y-4">
                      {[
                        ...
                        <div key={item} className="flex items-center gap-3">
                          <span className="bg-moss/14 text-moss grid h-7 w-7 place-items-center rounded-lg font-mono text-xs">
