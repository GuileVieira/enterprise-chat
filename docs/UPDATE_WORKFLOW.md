...
```bash
MONGO_URI=mongodb://127.0.0.1:27017/LibreChat (kept for upstream compatibility)
...
| Branch | Papel |
|---|---|
| `main` | Base sincronizada com `LibreChat/upstream`. Recebe o código original do projeto (upstream). |
...
Quando sair uma nova versão do upstream (LibreChat):
