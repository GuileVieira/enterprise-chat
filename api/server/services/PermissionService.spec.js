...
const { RoleBits, createModels, runAsSystem, tenantStorage } = require('@librechat/data-schemas');
  ...
  describe('getAvailableRoles', () => {
    ...
    test('should throw error for non-existent resource type', async () => {
      await expect(
        ...
        'Invalid resourceType: non_existent_type. Valid types: agent, project, codeEnvironment, promptGroup, mcpServer, remoteAgent, skill, sharedLink',
      );
    });
  });
