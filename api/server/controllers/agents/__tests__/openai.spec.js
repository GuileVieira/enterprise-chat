...
const mockLoadProjectContext = jest.fn().mockResolvedValue({
  projectId: undefined,
  projectFileIds: [],
  projectInstructions: '',
  projectMemories: '',
...
describe('OpenAIChatCompletionController', () => {
  ...
  describe('remote-agent file authorization', () => {
    it('threads the remote-agent permission boundary through initialization and tool loading', async () => {
      ...
      require('@librechat/api').validateRequest.mockReturnValueOnce({ request: req.body });
      await OpenAIChatCompletionController(req, res);
      ...
      await initializeParams.loadTools({
        ...
        projectFileIds: initializeParams.projectFileIds,
      });
