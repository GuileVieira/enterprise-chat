...
export function createModels(mongoose: typeof import('mongoose')): {
  ...
  TenantFunction: ReturnType<typeof createTenantFunctionModel>;
  TenantSecret: ReturnType<typeof createTenantSecretModel>;
  TrafficDiaryEntry: ReturnType<typeof createTrafficDiaryModel>;
  Meeting: ReturnType<typeof createMeetingModel>;
  AdminAudit: ReturnType<typeof createAdminAuditModel>;
