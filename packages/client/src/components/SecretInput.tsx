      ...
      <div className={cn('group/secret-input relative', containerClassName)}>
        ...
        >
          ...
          {showCopy && copyButton == null && (
            ...
            >
              {isCopied ? (
                <Check data-testid="secret-copied-icon" className="size-4" />
              ) : (
                <Copy data-testid="secret-copy-icon" className="size-4" />
              )}
            </button>
          )}
          <button
          ...
          >
            {isVisible ? (
              <EyeOff data-testid="secret-hide-icon" className="size-4" />
            ) : (
              <Eye data-testid="secret-show-icon" className="size-4" />
            )}
          </button>
        </div>
      </div>
