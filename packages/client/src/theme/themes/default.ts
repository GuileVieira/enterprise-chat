...
export const defaultTheme: IThemeRGB = {
  ...
  'rgb-text-warning': '146 64 14', // #92400e, AA on Orqest canvases
  ...
  // Ring colors
  'rgb-ring-primary': '71 85 105', // #475569 (slate-600)
  ...
  'rgb-surface-submit': '71 85 105', // #475569 (slate-600)
  'rgb-surface-submit-hover': '51 65 85', // #334155 (slate-700)
  ...
  // Brand colors
  'rgb-brand-purple': '126 34 206', // #7e22ce (purple-700), AA on light canvases
