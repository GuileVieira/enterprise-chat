...
function conversationMatchesProjectQuery(
  ...
  conversation: Pick<TConversation, 'projectId'>,
): boolean {
...
function conversationBelongsToListQuery(
  queryKey: readonly unknown[],
  conversation: Pick<TConversation, 'projectId' | 'isArchived'>,
): boolean {
  return (
...
function conversationInsertVerdict(
  queryKey: readonly unknown[],
  conversation: Pick<TConversation, 'projectId' | 'tags' | 'isArchived'>,
): ListInsertVerdict {
 ...
 */
export function getRouteProjectId(): string | null {
