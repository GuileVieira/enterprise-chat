# Orqest Localization Guide

This guide explains how to add new languages to Orqest's localization system.

## Adding a New Language

To add a new language to Orqest, follow these steps:

### 1. Add the Language to Locize Project

- Navigate to the [Orqest locize project](https://www.locize.app/cat/62uyy7c9), 
...
1. The empty translation file will be populated through Orqest's automated translation platform
