    ...
    <>
      ...
      {startupConfig?.registrationEnabled === true && (
        <p className="my-4 text-center text-sm text-text-secondary">
          ...
          <a
            href={registerPage()}
            className="inline-flex p-1 text-sm font-semibold text-surface-submit underline decoration-transparent transition-all duration-200 hover:text-surface-submit-hover hover:decoration-surface-submit-hover focus:text-surface-submit-hover focus:decoration-surface-submit-hover"
          >
