...
import { ArrowBendUpLeft, ArrowClockwise, Check, Copy, PencilSimple } from '@phosphor-icons/react';
    ...
    <div className="group visible flex justify-center gap-0.5 self-end focus-within:outline-none lg:justify-start">
      ...
      {!isSubagentThreadReadOnly && isEditableEndpoint && !hideEditButton && (
        <HoverButton
          ...
          icon={<PencilSimple size={19} aria-hidden="true" />}
          isActive={isEditing}
          isLast={isLast}
      ...
      {!isSubagentThreadReadOnly && regenerateEnabled && (
        <HoverButton
          ...
          icon={<ArrowClockwise size={19} aria-hidden="true" />}
          isLast={isLast}
      ...
      {!isSubagentThreadReadOnly && continueSupported && (
        <HoverButton
          ...
          icon={<ArrowBendUpLeft size={19} aria-hidden="true" />}
          isLast={isLast}
