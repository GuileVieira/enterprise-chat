...
describe('Footer', () => {
  test('renders the branded default footer without an upstream vendor link', () => {
    render(<Footer startupConfig={null} />);
    expect(screen.getByText(/Orqest/)).toBeInTheDocument();
    expect(screen.queryByRole('link', { name: /LibreChat/ })).toBeNull();
  });
