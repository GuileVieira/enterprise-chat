...
import { CONVERSATION_DRAG_TYPE, markExternalHover, useUnpinDroppedConversation } from './dnd';
...
const Conversations: FC<ConversationsProps> = ({
  ...
  /* Dropping a pinned chat on Chats removes it from the pinned section. */
