...
function UnifiedSidebar() {
  ...
  if (isSmallScreen) {
    return (
      <>
        <div
          className={cn(
            'shadow-sidebar-raycast fixed left-0 top-0 z-[110] flex h-full bg-surface-primary-alt',
  ...
  return (
    <SidebarChatProvider>
      <ActivePanelProvider>
        <aside
          className="shadow-sidebar-raycast relative z-[1] flex h-full flex-shrink-0 overflow-hidden"
          style={{
