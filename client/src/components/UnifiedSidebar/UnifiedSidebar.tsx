...
function UnifiedSidebar() {
  ...
  if (isSmallScreen) {
    return (
      <>
        <div
          className={cn(
            'fixed left-0 top-0 z-[110] flex h-full bg-surface-primary-alt shadow-sidebar-raycast',
  ...
  return (
    <SidebarChatProvider>
      <ActivePanelProvider>
        <aside
          className="relative z-[1] flex h-full flex-shrink-0 overflow-hidden shadow-sidebar-raycast"
          style={{
